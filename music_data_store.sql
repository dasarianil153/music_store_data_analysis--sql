...
--  Q9: Find how much amount spent by each customer on best selling artist artists? Write a query to return customer name, artist name and total spent
...
with cte as (select c.customer_id, first_name, last_name , billing_country, sum(total) as total_spending,
